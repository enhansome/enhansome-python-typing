...
* [mypy](https://github.com/python/mypy) ⭐ 20,650 | 🐛 3,236 | 🌐 Python | 📅 2026-09-25 - Optional static typing (PEP 484).
* [ty](https://github.com/astral-sh/ty) ⭐ 19,755 | 🐛 898 | 🌐 Python | 📅 2026-09-24 - An extremely fast Python type checker, written in Rust, from the creators of Ruff and uv.
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,659 | 🐛 324 | 🌐 Python | 📅 2026-09-25 - Fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
* [basedpyright](https://github.com/detachhead/basedpyright) ⭐ 3,610 | 🐛 649 | 🌐 TypeScript | 📅 2026-09-22 - Pyright fork with improvements to VSCode support and various other fixes.
* [pylyzer](https://github.com/mtshiba/pylyzer/) ⭐ 2,856 | 🐛 10 | 🌐 Rust | 📅 2025-05-10 - A fast static code analyzer & language server for Python, written in Rust.
* [zuban](https://github.com/zubanls/zuban) ⭐ 1,203 | 🐛 85 | 🌐 Rust | 📅 2026-09-26 - A Mypy-compatible Python type checker and Language Server built in Rust.
...
* [pycroscope](https://github.com/JelleZijlstra/pycroscope) ⭐ 48 | 🐛 3 | 🌐 Python | 📅 2026-08-29 - A semi-static type checker for Python code. It imports the modules it type checks, enabling `pycroscope` to understand many dynamic constructs that other type checkers will reject. This makes it possible to extend `pycroscope` with plugins that interact directly with your code.
* [PyCharm](https://www.jetbrains.com/pycharm/) - IDE for Professional Developers.

## Dynamic type checkers

* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 28,886 | 🐛 587 | 🌐 Python | 📅 2026-09-26 - Data parsing using Python type hinting. Supports dataclasses.
* [beartype](https://github.com/beartype/beartype) ⭐ 3,499 | 🐛 124 | 🌐 Python | 📅 2026-09-26 - Unbearably fast `O(1)` runtime type-checking in pure Python.
* [typeguard](https://github.com/agronholm/typeguard) ⭐ 1,789 | 🐛 50 | 🌐 Python | 📅 2026-08-29 - Another one runtime type checker.
...
* [trycast](https://github.com/davidfstr/trycast) ⭐ 89 | 🐛 5 | 🌐 Python | 📅 2025-12-10 - Parse JSON-like values whose shape is defined by typed dictionaries (TypedDicts) and other standard Python type hints.
* [type\_enforced](https://github.com/connor-makowski/type_enforced) ⭐ 64 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - Fast runtime type enforcement for annotations with no dependencies. Includes fast O(1) and full O(n) operations.
* [typedpy](https://github.com/loyada/typedpy) ⭐ 17 | 🐛 3 | 🌐 Python | 📅 2026-09-13 - Type-safe, strict Python. Works well with standard Python.

## Stub packages

* [boto3-stubs](https://vemel.github.io/boto3_stubs_docs/) - Stubs for [boto3](https://github.com/boto/boto3) ⭐ 9,909 | 🐛 200 | 🌐 Python | 📅 2026-09-25.
* [typeshed](https://github.com/python/typeshed) ⭐ 5,125 | 🐛 358 | 🌐 Python | 📅 2026-09-26 - Collection of library stubs, with static types.
* [django-stubs](https://github.com/typeddjango/django-stubs) ⭐ 1,974 | 🐛 174 | 🌐 Python | 📅 2026-09-25 - Stubs for [Django](https://github.com/django/django) ⭐ 91,193 | 🐛 525 | 🌐 Python | 📅 2026-09-26.
* [asgiref](https://github.com/django/asgiref) ⭐ 1,631 | 🐛 66 | 🌐 Python | 📅 2026-09-16 - ASGI specification, provides [asgiref.typing](https://github.com/django/asgiref/blob/main/asgiref/typing.py) ⭐ 1,631 | 🐛 66 | 🌐 Python | 📅 2026-09-16 module with type annotations for ASGI servers.
* [torchtyping](https://github.com/patrick-kidger/torchtyping) ⭐ 1,485 | 🐛 16 | 🌐 Python | 📅 2025-05-02 - Enhanced type annotations for [PyTorch](https://pytorch.org/).
* [types-aiobotocore](https://vemel.github.io/types_aiobotocore_docs/) - Stubs for [aiobotocore](https://github.com/aio-libs/aiobotocore) ⭐ 1,425 | 🐛 21 | 🌐 Python | 📅 2026-09-25.
* [sqlalchemy-stubs](https://github.com/dropbox/sqlalchemy-stubs) ⭐ 585 | 🐛 87 | 🌐 Python | 📅 2024-06-10 - Stubs for [SQLAlchemy](https://github.com/sqlalchemy/sqlalchemy) ⭐ 12,185 | 🐛 210 | 🌐 Python | 📅 2026-09-25.
* [djangorestframework-stubs](https://github.com/typeddjango/djangorestframework-stubs) ⭐ 541 | 🐛 65 | 🌐 Python | 📅 2026-09-25 - Stubs for [DRF](https://github.com/encode/django-rest-framework) ⭐ 30,192 | 🐛 48 | 🌐 Python | 📅 2026-09-24.
* [celery-types](https://github.com/sbdchd/celery-types) ⭐ 157 | 🐛 13 | 🌐 Python | 📅 2026-09-26 - Type stubs for [Celery](https://github.com/celery/celery) ⭐ 28,916 | 🐛 729 | 🌐 Python | 📅 2026-09-26 and its related packages [django-celery-results](https://github.com/celery/django-celery-results) ⭐ 784 | 🐛 64 | 🌐 Python | 📅 2026-08-31, [ampq](https://github.com/celery/py-amqp) ⭐ 314 | 🐛 37 | 🌐 Python | 📅 2026-09-22, [kombu](https://github.com/celery/kombu) ⭐ 3,143 | 🐛 214 | 🌐 Python | 📅 2026-09-23, [billiard](https://github.com/celery/billiard) ⭐ 434 | 🐛 85 | 🌐 Python | 📅 2026-09-21, [vine](https://github.com/celery/vine) ⭐ 127 | 🐛 8 | 🌐 Python | 📅 2026-09-26 and [ephem](https://github.com/brandon-rhodes/pyephem) ⭐ 896 | 🐛 5 | 🌐 C | 📅 2026-04-30.
* [scipy-stubs](https://github.com/jorenham/scipy-stubs) ⭐ 94 | 🐛 12 | 🌐 Python | 📅 2026-09-25 - Stubs for [SciPy](https://github.com/scipy/scipy) ⭐ 15,046 | 🐛 1,843 | 🌐 Python | 📅 2026-09-26.
...
* [grpc-stubs](https://github.com/shabbyrobe/grpc-stubs) ⚠️ Archived - Stubs for [grpc](https://github.com/grpc/grpc) ⭐ 45,342 | 🐛 1,359 | 🌐 C++ | 📅 2026-09-25.
...
* [python-phonenumbers-stubs](https://github.com/AA-Turner/python-phonenumbers-stubs) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2021-09-01 - Stubs for [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,772 | 🐛 11 | 🌐 Python | 📅 2026-09-24.
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,368 | 🐛 81 | 🌐 Python | 📅 2026-09-24 - Make your functions return something meaningful, typed, and safe.
...
* [optype](https://github.com/jorenham/optype) ⭐ 96 | 🐛 17 | 🌐 Python | 📅 2026-09-24 - Opinionated `collections.abc` and `operators` alternative: Flexible single-method protocols and typed operators with predictable names.
...
* [typing-extensions](https://github.com/python/typing_extensions) ⭐ 585 | 🐛 19 | 🌐 Python | 📅 2026-08-31 - Backported and experimental type hints.
...
* [Ruff](https://github.com/astral-sh/ruff/) ⭐ 49,803 | 🐛 2,186 | 🌐 Rust | 📅 2026-09-26 - Extremely fast linter which supports lint rules from many other lint tools, such as flake8.
...
* [flake8-type-checking](https://github.com/snok/flake8-type-checking) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-09-24 - Plugin to help you guard any type-annotation-only import correctly.
* [flake8-typing-only-imports](https://github.com/sondrelg/flake8-typing-only-imports) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-09-24 - flake8 plugin that helps identify which imports to put into type-checking blocks, and how to adjust your type annotations once imports are moved.
...
* [pytest-mypy-plugins](https://github.com/typeddjango/pytest-mypy-plugins) ⭐ 127 | 🐛 24 | 🌐 Python | 📅 2026-09-20 - Pytest plugin for testing mypy types, stubs, and plugins.
* [pytest-mypy-testing](https://github.com/davidfritzsche/pytest-mypy-testing) ⭐ 34 | 🐛 12 | 🌐 Python | 📅 2026-01-26 - Pytest plugin to test mypy static type analysis.
* [mypy-test](https://github.com/orsinium-labs/mypy-test) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2023-10-24 - Test mypy plugins, stubs, custom types.

### Working with types

* [mypyc](https://github.com/python/mypy/tree/master/mypyc) ⭐ 20,650 | 🐛 3,236 | 🌐 Python | 📅 2026-09-25 - Compiles mypy-annotated, statically typed Python modules into CPython C extensions.
...
* [monkeytype](https://github.com/instagram/MonkeyType) ⭐ 5,004 | 🐛 78 | 🌐 Python | 📅 2026-02-11 - Collects runtime types of function arguments and return values, and can automatically generate stub files or even add draft type annotations directly to your code based on the types collected at runtime.
...
* [RightTyper](https://github.com/RightTyper/RightTyper) ⭐ 359 | 🐛 22 | 🌐 Python | 📅 2026-09-09 - A tool that generates types for your function arguments and return values. RightTyper lets your code run at nearly full speed with almost no memory overhead.
...
* [jsonschema-gentypes](https://github.com/camptocamp/jsonschema-gentypes) ⭐ 49 | 🐛 19 | 🌐 Python | 📅 2026-09-03 - Generate Python types based on TypedDict from a JSON Schema.
...
* [mypy/plugins](https://github.com/python/mypy/tree/master/mypy/plugins) ⭐ 20,650 | 🐛 3,236 | 🌐 Python | 📅 2026-09-25 - Plugins already integrated into mypy.
...
* [loguru-mypy](https://github.com/kornicameister/loguru-mypy) ⭐ 22 | 🐛 16 | 🌐 Python | 📅 2024-05-01 - Plugin for [loguru](https://github.com/Delgan/loguru) ⭐ 24,130 | 🐛 257 | 🌐 Python | 📅 2026-08-30 support.
* [pynamodb-mypy](https://github.com/pynamodb/pynamodb-mypy) ⭐ 5 | 🐛 2 | 🌐 Python | 📅 2022-10-21 - Plugin for [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,646 | 🐛 321 | 🌐 Python | 📅 2026-05-29 support.
...
* [pylance](https://github.com/microsoft/pylance-release) ⭐ 2,123 | 🐛 23 | 🌐 Python | 📅 2026-09-25 - PyRight integration for VSCode.
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,206 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - Run type checkers (e.g. Mypy) on Jupyter Notebooks.
...
* [mypy-playground](https://github.com/ymyzk/mypy-playground) ⭐ 77 | 🐛 45 | 🌐 Python | 📅 2026-09-26 - Online playground for mypy.
...
* [Python-typing-koans](https://github.com/kracekumar/python-typing-koans/) ⭐ 121 | 🐛 7 | 🌐 Python | 📅 2021-12-18 - A set of examples to learn optional static typing in Python.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 323,248 | 🐛 21 | 🌐 Python | 📅 2026-09-25 - Curated list of awesome Python frameworks, libraries, software and resources.
