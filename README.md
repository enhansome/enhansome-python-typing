...
* [mypy](https://github.com/python/mypy) ⭐ 20,599 | 🐛 3,199 | 🌐 Python | 📅 2026-08-24 - Optional static typing (PEP 484).
* [ty](https://github.com/astral-sh/ty) ⭐ 19,544 | 🐛 903 | 🌐 Python | 📅 2026-08-22 - An extremely fast Python type checker, written in Rust, from the creators of Ruff and uv.
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,596 | 🐛 337 | 🌐 Python | 📅 2026-08-22 - Fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
* [pyrefly](https://github.com/facebook/pyrefly) ⭐ 6,904 | 🐛 672 | 🌐 Rust | 📅 2026-08-24 - A fast type checker and language server for Python.
...
* [basedpyright](https://github.com/detachhead/basedpyright) ⭐ 3,546 | 🐛 650 | 🌐 TypeScript | 📅 2026-08-21 - Pyright fork with improvements to VSCode support and various other fixes.
...
* [zuban](https://github.com/zubanls/zuban) ⭐ 1,168 | 🐛 96 | 🌐 Rust | 📅 2026-08-24 - A Mypy-compatible Python type checker and Language Server built in Rust.
...
* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 28,606 | 🐛 576 | 🌐 Python | 📅 2026-08-24 - Data parsing using Python type hinting. Supports dataclasses.
* [beartype](https://github.com/beartype/beartype) ⭐ 3,486 | 🐛 115 | 🌐 Python | 📅 2026-08-22 - Unbearably fast `O(1)` runtime type-checking in pure Python.
...
* [boto3-stubs](https://vemel.github.io/boto3_stubs_docs/) - Stubs for [boto3](https://github.com/boto/boto3) ⭐ 9,876 | 🐛 191 | 🌐 Python | 📅 2026-08-21.
* [typeshed](https://github.com/python/typeshed) ⭐ 5,113 | 🐛 366 | 🌐 Python | 📅 2026-08-24 - Collection of library stubs, with static types.
* [django-stubs](https://github.com/typeddjango/django-stubs) ⭐ 1,969 | 🐛 180 | 🌐 Python | 📅 2026-08-24 - Stubs for [Django](https://github.com/django/django) ⭐ 88,763 | 🐛 472 | 🌐 Python | 📅 2026-08-23.
* [asgiref](https://github.com/django/asgiref) ⭐ 1,630 | 🐛 65 | 🌐 Python | 📅 2026-08-10 - ASGI specification, provides [asgiref.typing](https://github.com/django/asgiref/blob/main/asgiref/typing.py) ⭐ 1,630 | 🐛 65 | 🌐 Python | 📅 2026-08-10 module with type annotations for ASGI servers.
...
* [types-aiobotocore](https://vemel.github.io/types_aiobotocore_docs/) - Stubs for [aiobotocore](https://github.com/aio-libs/aiobotocore) ⭐ 1,423 | 🐛 22 | 🌐 Python | 📅 2026-08-22.
* [sqlalchemy-stubs](https://github.com/dropbox/sqlalchemy-stubs) ⭐ 583 | 🐛 87 | 🌐 Python | 📅 2024-06-10 - Stubs for [SQLAlchemy](https://github.com/sqlalchemy/sqlalchemy) ⭐ 12,103 | 🐛 215 | 🌐 Python | 📅 2026-08-24.
* [djangorestframework-stubs](https://github.com/typeddjango/djangorestframework-stubs) ⭐ 538 | 🐛 66 | 🌐 Python | 📅 2026-08-24 - Stubs for [DRF](https://github.com/encode/django-rest-framework) ⭐ 30,144 | 🐛 56 | 🌐 Python | 📅 2026-08-19.
* [celery-types](https://github.com/sbdchd/celery-types) ⭐ 156 | 🐛 13 | 🌐 Python | 📅 2026-07-29 - Type stubs for [Celery](https://github.com/celery/celery) ⭐ 28,817 | 🐛 798 | 🌐 Python | 📅 2026-08-22 and its related packages [django-celery-results](https://github.com/celery/django-celery-results) ⭐ 786 | 🐛 61 | 🌐 Python | 📅 2026-08-17, [ampq](https://github.com/celery/py-amqp) ⭐ 316 | 🐛 45 | 🌐 Python | 📅 2026-07-04, [kombu](https://github.com/celery/kombu) ⭐ 3,135 | 🐛 234 | 🌐 Python | 📅 2026-08-24, [billiard](https://github.com/celery/billiard) ⭐ 435 | 🐛 87 | 🌐 Python | 📅 2026-08-17, [vine](https://github.com/celery/vine) ⭐ 128 | 🐛 14 | 🌐 Python | 📅 2026-08-17 and [ephem](https://github.com/brandon-rhodes/pyephem) ⭐ 894 | 🐛 4 | 🌐 C | 📅 2026-04-30.
* [scipy-stubs](https://github.com/jorenham/scipy-stubs) ⭐ 93 | 🐛 14 | 🌐 Python | 📅 2026-08-24 - Stubs for [SciPy](https://github.com/scipy/scipy) ⭐ 14,950 | 🐛 1,845 | 🌐 Python | 📅 2026-08-24.
...
* [grpc-stubs](https://github.com/shabbyrobe/grpc-stubs) ⚠️ Archived - Stubs for [grpc](https://github.com/grpc/grpc) ⭐ 45,251 | 🐛 1,383 | 🌐 C++ | 📅 2026-08-24.
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,354 | 🐛 81 | 🌐 Python | 📅 2026-08-24 - Make your functions return something meaningful, typed, and safe.
...
* [Ruff](https://github.com/astral-sh/ruff/) ⭐ 49,300 | 🐛 2,144 | 🌐 Rust | 📅 2026-08-24 - Extremely fast linter which supports lint rules from many other lint tools, such as flake8.
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,892 | 🐛 13 | 🌐 Python | 📅 2026-08-22 - The strictest and most opinionated Python linter ever.
...
* [mypyc](https://github.com/python/mypy/tree/master/mypyc) ⭐ 20,599 | 🐛 3,199 | 🌐 Python | 📅 2026-08-24 - Compiles mypy-annotated, statically typed Python modules into CPython C extensions.
...
* [RightTyper](https://github.com/RightTyper/RightTyper) ⭐ 358 | 🐛 5 | 🌐 Python | 📅 2026-05-22 - A tool that generates types for your function arguments and return values. RightTyper lets your code run at nearly full speed with almost no memory overhead.
...
* [jsonschema-gentypes](https://github.com/camptocamp/jsonschema-gentypes) ⭐ 48 | 🐛 19 | 🌐 Python | 📅 2026-08-21 - Generate Python types based on TypedDict from a JSON Schema.
...
* [mypy/plugins](https://github.com/python/mypy/tree/master/mypy/plugins) ⭐ 20,599 | 🐛 3,199 | 🌐 Python | 📅 2026-08-24 - Plugins already integrated into mypy.
...
* [loguru-mypy](https://github.com/kornicameister/loguru-mypy) ⭐ 22 | 🐛 16 | 🌐 Python | 📅 2024-05-01 - Plugin for [loguru](https://github.com/Delgan/loguru) ⭐ 24,079 | 🐛 253 | 🌐 Python | 📅 2026-08-23 support.
...
* [pylance](https://github.com/microsoft/pylance-release) ⭐ 2,113 | 🐛 143 | 🌐 Python | 📅 2026-08-18 - PyRight integration for VSCode.
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,203 | 🐛 22 | 🌐 Python | 📅 2026-08-22 - Run type checkers (e.g. Mypy) on Jupyter Notebooks.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 315,815 | 🐛 17 | 🌐 Python | 📅 2026-08-24 - Curated list of awesome Python frameworks, libraries, software and resources.
